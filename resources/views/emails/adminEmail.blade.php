...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_menu_1 .v-container-padding-padding { padding: 10px !important; } }
    </style>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: book antiqua,palatino; font-size: 35px; ">Admin! Prueba Laravel</h1>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h3 style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: book antiqua,palatino; font-size: 18px; ">Cantidad de usuarios registrados por país<br /></h3>
           
        <table align="center" style="border: 1px #FFFFFF solid">
            <thead>
                <tr>
                    <th style="border: 1px #FFFFFF solid">Pais</th>
                    <th style="border: 1px #FFFFFF solid">Numero de usuarios</th>
                </tr>
            </thead>
            <tbody>                
                @foreach($data as $item)
                <tr>
                    <th style="border: 1px #FFFFFF solid">{{ $item['country'] }}</td>
                    <th style="border: 1px #FFFFFF solid">{{ $item['user_count'] }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
